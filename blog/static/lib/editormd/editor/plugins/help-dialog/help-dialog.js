...
(function() {
	...
	var factory = function (exports) {
		...
		exports.fn.helpDialog = function() {
			...
			{			
				var dialogContent = "<div class=\"markdown-body\" style=\"fonts-family:微软雅黑, Helvetica, Tahoma, STXihei,Arial;height:390px;overflow:auto;fonts-size:14px;border-bottom:1px solid #ddd;padding:0 20px 20px 0;\"></div>";
