...
(function(mod) {
  ...
  var wordOperators = ["in", "and", "or", "not", "is a", "is", "isnt", "defined", "if unless"],
      ...
      commonDef = ["@fonts-face", "@keyframes", "@media", "@viewport", "@page", "@host", "@supports", "@block", "@css"],
